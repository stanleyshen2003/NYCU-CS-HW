...
x3 = u3.^3*p3(1,1)+u3.^2*p3(2,1)+u3*p3(3,1)+p3(4,1);
y3 = u3.^3*p3(1,2)+u3.^2*p3(2,2)+u3*p3(3,2)+p3(4,2);
count = count +1;

u4 = linspace(0,1);
p4 = matrix*[pts(count,1:2);pts(count+1,1:2);pts(count+2,1:2) ;pts(count+3,1:2)];
x4 = u4.^3*p4(1,1)+u4.^2*p4(2,1)+u4*p4(3,1)+p4(4,1);
y4 = u4.^3*p4(1,2)+u4.^2*p4(2,2)+u4*p4(3,2)+p4(4,2);
count = count +1;

u5 = linspace(0,1);
p5 = matrix*[pts(count,1:2);pts(count+1,1:2);pts(count+2,1:2) ;pts(count+3,1:2)];
x5 = u5.^3*p5(1,1)+u5.^2*p5(2,1)+u5*p5(3,1)+p5(4,1);
y5 = u5.^3*p5(1,2)+u5.^2*p5(2,2)+u5*p5(3,2)+p5(4,2);
count = count +1;

u6 = linspace(0,1);
p6 = matrix*[pts(count,1:2);pts(count+1,1:2);pts(count+2,1:2) ;pts(count+3,1:2)];
x6 = u6.^3*p6(1,1)+u6.^2*p6(2,1)+u6*p6(3,1)+p6(4,1);
y6 = u6.^3*p6(1,2)+u6.^2*p6(2,2)+u6*p6(3,2)+p6(4,2);
count = count +1;

p7 = matrix*[pts(count,1:2);pts(count+1,1:2);pts(count+2,1:2) ;pts(count+3,1:2)];
x7 = u6.^3*p7(1,1)+u6.^2*p7(2,1)+u6*p7(3,1)+p7(4,1);
y7 = u6.^3*p7(1,2)+u6.^2*p7(2,2)+u6*p7(3,2)+p7(4,2);
disp(count)
count = count +1;
